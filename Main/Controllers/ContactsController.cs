...
namespace AspWebApi.Controllers {
    ...
    public class ContactsController : ControllerBase {
        ...
        public IActionResult GetMessagesByContact(string id)
        {
            ...
            var msgList = messages.Select(m => new MessageResponse(m.Id, m.Text, m.WrittenIn.ToString("dd/MM/yyyy HH:mm", CultureInfo.InvariantCulture), m.Sent, m.Username)).ToList();
        ...
        public IActionResult GetLastMessage(string id)
        {
            ...
            return Ok(UpdateSentSingle(new MessageResponse(m.Id, m.Text, m.WrittenIn.ToString("dd/MM/yyyy HH:mm", CultureInfo.InvariantCulture), m.Sent, m.Username)));
        }
