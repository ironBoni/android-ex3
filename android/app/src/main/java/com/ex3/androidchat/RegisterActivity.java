    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            private boolean isValidPassword(String password) {
                ...
                if(!isOk) {
                    Toast.makeText(RegisterActivity.this, "Password must contain " +
                            "digits and at least one capital letter", Toast.LENGTH_SHORT).show();
                }
                return isOk;
            }
            ...
            private boolean isValidUser(String userId) {
                ...
                if(userId.indexOf(' ') >= 0) {
                    Toast.makeText(RegisterActivity.this, "User cannot have spaces!", Toast.LENGTH_SHORT).show();
                    return false;
                }
            ...
            private boolean hasEnteredAllFields() {
                ...
                if(binding.txtNickname.toString().isEmpty()) {
                    Toast.makeText(RegisterActivity.this, "Enter Nickname!", Toast.LENGTH_SHORT).show();
                    return false;
                }
